...
from smart_contract_assistant.ingestion import load_or_create_empty_index
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="2.0",
        description="RAG-based Smart Contract Analysis API powered by LangChain & OpenAI",
    )
